...
long long maze_11()
{
    ...
    vector<string> archivos = { "maze_1.txt","maze_2.txt","maze_3.txt","maze_4.txt","maze_5.txt","maze_6.txt","maze_7.txt","maze_8.txt","maze_9.txt","maze_10.txt","maze_11.txt","maze_12.txt" };
